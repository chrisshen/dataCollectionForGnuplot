...
// void saveDelay( std::vector<double>, dataMapVecType&, float );
...
void
STMAC_collectData( 	struct dirent*,
					std::string,
					dataMapVecType&, 
					dataMapVecType& );

void
STMAC_collectData_forLMA( 	struct dirent*,
					std::string,
					dataMapVecType&, 
					dataMapVecType& );

void
STMAC_collectData_forEDCAn( 	struct dirent*,
					std::string,
					dataMapVecType&, 
					dataMapVecType& );

void
STMAC_collectData_forEDCAd( 	struct dirent*,
					std::string,
					dataMapVecType&, 
					dataMapVecType& );